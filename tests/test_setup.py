...
def mock_language_system():
    ...
    with patch("helpmesign.utils.language_manager.get_text", mock_text), patch(
        "helpmesign.utils.language_manager.get_list", mock_list
...
def mock_font_system():
    ...
    with patch("helpmesign.utils.font_manager.get_title_font", mock_font), patch(
        "helpmesign.utils.font_manager.get_heading_font", mock_font
    ), patch("helpmesign.utils.font_manager.get_body_font", mock_font), patch(
        "helpmesign.utils.font_manager.get_label_font", mock_font
    ), patch(
        "helpmesign.utils.font_manager.get_button_font", mock_font
    ), patch(
        "helpmesign.utils.font_manager.get_input_font", mock_font
    ), patch(
        "helpmesign.utils.font_manager.get_small_font", mock_font
    ):
        yield mock_font
...
def mock_resource_system():
    ...
    with patch(
        "helpmesign.utils.resource_manager.ResourceManager",
...
def mock_logging_system():
    ...
    with patch("helpmesign.utils.logger.get_logger", return_value=mock_logger), patch(
        "helpmesign.utils.logger.setup_logging", return_value=mock_logger
    ):
        yield mock_logger
