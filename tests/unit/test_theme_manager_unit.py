...
class TestThemeManagerRealImplementation:
    ...
    def test_apply_to_application(
        self, mock_qcolor, mock_qpalette, mock_qapplication, mock_logger
    ):
...
class TestThemeManagerGlobalFunctions:
    ...
    def test_get_theme_manager_singleton(self, mock_logger):
        ...
        from src.helpmesign.utils.theme_manager import _theme_manager, get_theme_manager
    ...
    def test_apply_font_size_to_widget_tree_function(
        ...
        mock_manager.apply_font_size_to_widget_tree.assert_called_once_with(
            mock_widget, {"QPushButton": "button_primary"}
        )
