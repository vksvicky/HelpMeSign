#!/usr/bin/env python3
"""
Simple unit tests for sign.mt integration
Tests the core functionality without importing the actual module
"""
...
class MockResourceManager:
    def get_resource_path(self, path):
        return os.path.join(
            os.path.dirname(__file__), "..", "..", "..", "resources", path
        )
...
class TestSignMTIntegrationSimple(unittest.TestCase):
    """Simple test cases for sign.mt integration"""
