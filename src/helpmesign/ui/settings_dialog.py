...
class SegmentedControl(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        self.options = [get_text("modes.sign_translate.name"), get_text("modes.learn.name")]
    ...
    def paintEvent(self, event):
        ...
        for i, option in enumerate(self.options):
            ...
            text_rect = painter.boundingRect(x, y, segment_width, segment_height, 
                                           Qt.AlignCenter, option)
...
def show_settings_dialog(parent=None, current_mode: str = "Sign & Translate", 
