...
from PySide6.QtWidgets import (
    ...
    QLabel, QLineEdit, QTextEdit, QPushButton, QFrame, QMessageBox,
    QMenuBar, QSizePolicy, QScrollArea
)
from PySide6.QtCore import Qt, Signal, QSize
from PySide6.QtGui import QFont, QIcon, QKeySequence, QAction, QShortcut

from ..utils.font_manager import (
    get_label_font, get_input_font, get_button_font, get_body_font, get_small_font
)
...
class StatusBar(QFrame):
    ...
    def setup_ui(self):
        ...
        # Mode label
        self.mode_label = QLabel(f"{get_text('ui.status.mode_prefix')}{get_text('modes.sign_translate.name')}")
