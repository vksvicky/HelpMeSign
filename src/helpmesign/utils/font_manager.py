...
class FontManager:
    ...
    def _ensure_fonts_loaded(self) -> None:
        ...
        try:
                ...
                if os.path.exists(font_path) and os.path.getsize(font_path) > 0:
                    try:
                        ...
                        if font_id != -1:
                            ...
                            if families:
                                self.font_families[filename] = families[0]  # Use first family name
            ...
            if self.font_families:
                ...
                self.logger.debug(f"Available font families: {list(self.font_families.values())}")
            else:
    ...
    def get_font(self, family: str = "Roboto", size: int = 10, weight: int = QFont.Normal, italic: bool = False) -> QFont:
...
def get_font(family: str = "Roboto", size: int = 10, weight: int = QFont.Normal, italic: bool = False) -> QFont:
    """Get a QFont object for Qt widgets"""
