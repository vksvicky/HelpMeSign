                ...
                if isinstance(value, dict) and key in value:
                    ...
                    for fallback_key in keys:
                        if (
                            ...
                            and fallback_key in fallback_value
                        ):
                ...
                if isinstance(value, dict) and key in value:
                    ...
                    for fallback_key in keys:
                        if (
                            ...
                            return default
                    return (
                        fallback_value if isinstance(fallback_value, list) else default
                    )
                ...
                if isinstance(value, dict) and key in value:
                    ...
                    for fallback_key in keys:
                        if (
                            ...
                            return default
                    return (
                        fallback_value if isinstance(fallback_value, dict) else default
                    )
