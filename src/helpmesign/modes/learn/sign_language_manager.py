"""
Sign Language Selection Management for Learn Mode
Contains sign language selection and UI management methods extracted from learn_mode.py
"""
...
class LearnModeSignLanguageManager:
    """Sign language selection and UI management methods for Learn Mode"""
